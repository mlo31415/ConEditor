...
###########################################################################
## Class GeneratedConInstanceFrame
###########################################################################

class GeneratedConInstanceFrame ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.Bind( wx.EVT_RIGHT_DOWN, self.GeneratedConInstanceFrameOnContextMenu )
	...
	def GeneratedConInstanceFrameOnContextMenu( self, event ):
